...
int main() {
  ...
  //  .CHECK_EQUAL("h e l l o 1.1 2.1 3.1 4.1", iterable_to_string(chain("hello", range(1.1,5.1)))) 
   ...
   .CHECK_EQUAL("1.1,1 1.1,2 2.1,1 2,2.1", iterable_to_string (product(range(1.1,3.1), range(1,3))))
    ...
    .CHECK_EQUAL("{} {1} {2} {1,2} {3} {1,3} {2,3} {1,2,3}" ,iterable_to_string(powerset(range(1,4))))
    .CHECK_EQUAL("{} {1.1} {2.1} {1.1,2.1} {3.1} {1.1,3.1} {2.1,3.1} {1.1,2.1,3.1}", iterable_to_string(powerset(range(1.1,4.1))))
    .CHECK_EQUAL("{} {a} {b} {a,b}",  iterable_to_string(powerset(range('a','c'))))
    .CHECK_EQUAL("{} {a} {b} {a,b} {c} {a,c} {b,c} {a,b,c}", iterable_to_string(powerset("abc")))
    .CHECK_EQUAL("{}", iterable_to_string(powerset("")))   
    ;
